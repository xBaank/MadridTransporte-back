...
public class ApiException(string message, int statusCode) : Exception(message)
{
    ...
    public static ApiException NotFound(string? message = null) => new(message ?? "Not found", 404);
    ...
    public static ApiException Conflict(string? message = null) => new(message ?? "Conflict", 409);
